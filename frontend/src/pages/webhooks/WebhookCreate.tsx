            ...
            <div className="card bg-base-100 shadow-xl max-w-2xl">
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end mt-4">
                        <button onClick={() => navigate(navigations.webhooks)} className="btn btn-ghost">Cancel</button>
                        <button onClick={handleSave} className="btn btn-primary">Save Webhook</button>
                    </div>
                </div>
            </div>
